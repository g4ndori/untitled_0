...
def main(skip_intro=False):
    ...
    if not skip_intro:
        ...
        screen.fill((0, 0, 0))
        loading_font_g4 = pygame.font.Font("Cookies.ttf", 20)
    ...
    while not game_started and running:
        ...
        back_title_font = pygame.font.Font("770Balsa-Regular.ttf", 32)
        title_font = pygame.font.Font("770Balsa-Regular.ttf", 32)
