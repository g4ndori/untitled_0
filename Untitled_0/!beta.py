...
bg_img = pygame.image.load("imgSet/background_img.png").convert()
...
large_bold_font = pygame.font.SysFont("malgungothic", 30, True)
...
def game_over_screen(kill_count, gold):
    ...
    while True:
        ...
        title = large_bold_font.render("Game Over!", True, (255, 0, 0))
        ...
        restart_text = large_bold_font.render("Main", True, (255, 255, 255))
        exit_text = large_bold_font.render("Exit", True, (255, 255, 255))
...
def main(skip_intro=False):
    cndrur_img = pygame.image.load("imgSet/ufo_shit1.png").convert_alpha()
    ...
    if not skip_intro:
        ...
        screen.fill((0, 0, 0))
        loading_font_g4 = pygame.font.Font("fonts/Cookies.ttf", 20)
        #loading_font_g5 = pygame.font.Font("Cookies.ttf", 60)
        loading_text1 = loading_font_g4.render("Made by g4ndori §", True, (255, 255, 255))
        
        #loading_text2 = loading_font_g5.render("§", True, (255, 255, 255))
        screen.blit(loading_text1, (200, 350))
        #screen.blit(loading_text2, (200, 400))
        text_surface = loading_text1.convert_alpha()
        #text_surface = loading_text2.convert_alpha()
        ...
        loading_phases = ["Loading.", "Loading..", "Loading..."]
        for _ in range(random.randrange(1, 5)):
                            for phase in loading_phases:
                                screen.fill((0, 0, 0))
                                loading_font = pygame.font.SysFont("malgungothic", 10, True)
                                loading_text = loading_font.render(phase, True, (255, 255, 255))
                                screen.blit(loading_text, (
                                    size[0] // 2 - loading_text.get_width() // 2,
                                    size[1] // 2 - loading_text.get_height() // 2
                                ))
                                pygame.display.update()
    ...
    while not game_started and running:
        ...
        back_title_font = pygame.font.Font("fonts/770Balsa-Regular.ttf", 32)
        title_font = pygame.font.Font("fonts/770Balsa-Regular.ttf", 32)
        ...
        screen.blit(back_title, (122, 249))
        screen.blit(title, (120, 250))
    
        button_setting = pygame.Rect(125, 370, 130, 50)
        pygame.draw.rect(screen, (0, 10, 0), button_setting)
        setting_text_font = pygame.font.SysFont("malgungothic", 20, True)
        setting_text = setting_text_font.render("Setting", True, (255, 255, 255))
        screen.blit(setting_text, (button_setting.x + 30, button_setting.y + 7))

        button_start = pygame.Rect(125, 310, 130, 50)
        pygame.draw.rect(screen, (0, 10, 0), button_start)
        start_text_font = pygame.font.SysFont("malgungothic", 20, True)
        start_text = start_text_font.render("Start", True, (255, 255, 255))
        screen.blit(start_text, (button_start.x + 35, button_start.y + 7))

        button_quit = pygame.Rect(125, 430, 130, 50)
        pygame.draw.rect(screen, (0, 10, 0), button_quit)
        quit_text_font = pygame.font.SysFont("malgungothic", 20, True)
        quit_text = quit_text_font.render("Quit", True, (255, 255, 255))
        screen.blit(quit_text, (button_quit.x + 30, button_quit.y +7))
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if button_quit.collidepoint(event.pos):
                    pygame.quit()
                    main()
                elif button_setting.collidepoint(event.pos):
                    screen.fill((0, 0, 0))
                    setting_font = pygame.font.SysFont("malgungothic", 15)
                    setting_text1 = setting_font.render("[<] Key / [>] Key : Move", True, (255, 255, 255))
                    setting_text2 = setting_font.render("[S] Key : Open/Close Shop", True, (255, 255, 255))
                    setting_text3 = setting_font.render("[R] Key : Reset the Game", True, (255, 255, 255))
                    setting_close = setting_font.render("Closed in 4s", True, (255, 255, 255))
                    screen.blit(setting_text1, (100, 100))
                    screen.blit(setting_text2, (100, 140))
                    screen.blit(setting_text3, (100, 170))
                    screen.blit(setting_close, (100, 50))
                    pygame.display.update()
                    pygame.time.delay(1000)
                    screen.fill((0, 0, 0))
                    setting_font = pygame.font.SysFont("malgungothic", 15)
                    ...
                    setting_text2 = setting_font.render("[S] Key : Open/Close Shop", True, (255, 255, 255))
                    setting_text3 = setting_font.render("[R] Key : Reset the Game", True, (255, 255, 255))
                    setting_close = setting_font.render("Closed in 3s", True, (255, 255, 255))
                    screen.blit(setting_text1, (100, 100))
                    screen.blit(setting_text2, (100, 140))
                    screen.blit(setting_text3, (100, 170))
                    screen.blit(setting_close, (100, 50))
                    ...
                    setting_text2 = setting_font.render("[S] Key : Open/Close Shop", True, (255, 255, 255))
                    setting_text3 = setting_font.render("[R] Key : Reset the Game", True, (255, 255, 255))
                    setting_close = setting_font.render("Closed in 2s", True, (255, 255, 255))
                    screen.blit(setting_text1, (100, 100))
                    screen.blit(setting_text2, (100, 140))
                    screen.blit(setting_text3, (100, 170))
                    screen.blit(setting_close, (100, 50))
                    ...
                    setting_text2 = setting_font.render("[S] Key : Open/Close Shop", True, (255, 255, 255))
                    setting_text3 = setting_font.render("[R] Key : Reset the Game", True, (255, 255, 255))
                    setting_close = setting_font.render("Closed in 1s", True, (255, 255, 255))
                    screen.blit(setting_text1, (100, 100))
                    screen.blit(setting_text2, (100, 140))
                    screen.blit(setting_text3, (100, 170))
                    screen.blit(setting_close, (100, 50))
                    ...
                    screen.blit(loading_text, (size[0] // 2 - loading_text.get_width() // 2,
                                            size[1] // 2 - loading_text.get_height() // 2))
                    pygame.display.update()
                    pygame.time.delay(random.randrange(100, 2000))
    ...
    while True:
        background = objc()
        background.put_img("imgSet/background_img.png")
        background.change_size(400, 700)

        ufo = objc()
        ufo.put_img("imgSet/ufo_shit1.png")
        ...
        bomb_img = pygame.image.load("imgSet/bombb.png").convert_alpha()
        bomb_img = pygame.transform.scale(bomb_img, (5, 15))
        bomb_size = bomb_img.get_size()


        enm_img = pygame.image.load("imgSet/enm.png").convert_alpha()
        enm_img = pygame.transform.scale(enm_img, (40, 40))
        enm_size = enm_img.get_size()

        shield_img = pygame.image.load("imgSet/shield1.png").convert_alpha()
        ...
        while MainEv == 0:
            ...
            for event in pygame.event.get():
                if event.type == pygame.KEYDOWN:
                    if event.key == pygame.K_r:
                        loading_phases = ["Resetting the Game.", "Resetting the Game..", "Resetting the Game..."]
                        for _ in range(random.randrange(1, 5)):
                            for phase in loading_phases:
                                screen.fill((255, 255, 255))
                                loading_font = pygame.font.SysFont("malgungothic", 10, True)
                                loading_text = loading_font.render(phase, True, (0, 0, 0))
                                screen.blit(loading_text, (
                                    size[0] // 2 - loading_text.get_width() // 2,
                                    size[1] // 2 - loading_text.get_height() // 2
                                ))
            ...
            if shop_open:
                screen.fill((30, 30, 30))
                shop_title_font = pygame.font.SysFont("malgungothic", 15, True)
                shop_title = shop_title_font.render("Shop (Close to [S] key)", True, (255, 255, 255))
            ...
            for i in range(len(bombList)):
                for j in range(len(enList)):
                    ...
                    if crash(bomb, enm):
                        ...
                        if enm.hp <= 0:
                            denmList.append(j)
                            gained_gold = random.randrange(5, 30) #골드!
                            gold += gained_gold
                            kill_count += 1
